...
{
	int skin, weapon1, weapon1_ammo, weapon2, weapon2_ammo, weapon3, weapon3_ammo, id;
	double x, y, z, angle;
    ...
    id = sampgdk_AddPlayerClass(skin, x, y, z, angle, weapon1, weapon1_ammo, weapon2, weapon2_ammo, weapon3, weapon3_ammo);
	RETVAL_LONG(id);
}
